...
QT_MOC_LITERAL(3, 28, 4)
    ...
    "NetworkManager\0getPassword\0\0pass"
};
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->getPassword((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (NetworkManager::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkManager::getPassword)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void NetworkManager::getPassword(QString _t1)
{
