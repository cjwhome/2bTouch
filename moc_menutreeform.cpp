...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MenuTreeForm_t, stringdata) + ofs \
...
const QMetaObject MenuTreeForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MenuTreeForm.data,
      qt_meta_data_MenuTreeForm,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MenuTreeForm.stringdata))
        return static_cast<void*>(const_cast< MenuTreeForm*>(this));
