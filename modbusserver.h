...
#include <QObject>
#include <QtNetwork> //replacement for #include <QtNetwork>
#include <QList>
#include <QSettings>
#include <QDebug>
#include <sstream>
...
public slots:
    ...
    QByteArray* read_multiple_registers(modbusRequest *req, QByteArray *data);
    QByteArray* write_multiple_register(modbusRequest *req, QByteArray *data);
