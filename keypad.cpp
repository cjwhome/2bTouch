...
Keypad::Keypad(QLineEdit *line,QWidget *parent) :
        QDialog(parent,Qt::FramelessWindowHint),
    ui(new Ui::Keypad)
{
    ui->setupUi(this);
    capitals = false;     //change this to true if you want to set all first characters to uppercase
    t1= false;
    pad_edit=line;
    ...
    this->setStyleSheet("background-image: url(:/keyboard/Touch-Keyboard-Line.png);");
}

Keypad::Keypad(QLineEdit *line, QString * string, QWidget *parent)  :
    QDialog(parent,Qt::FramelessWindowHint),
ui(new Ui::Keypad){
    ui->setupUi(this);
    capitals = false;     //change this to true if want to set all first characters to uppercase
    t1= false;
    pad_edit=line;
...
void Keypad::setnumeric(){
    setStyleSheet(" background-image: url(:/keyboard/Touch-Keyboard2-Line.png);");
    ui->abutton->setText("-");
    ui->bbutton->setText("'");
    ui->cbutton->setText("?");
    ui->dbutton->setText(":");
...
void Keypad::setsymbol(){
    setStyleSheet("background-image: url(:/keyboard/Touch-Keyboard1-Line.png);");
    ui->abutton->setText("A");
    ui->bbutton->setText("B");
    ui->cbutton->setText("C");
    ui->dbutton->setText("D");
